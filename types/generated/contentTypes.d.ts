...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles for BabyVision ecosystem';
...
export interface ApiVoucherVoucher extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Voucher codes for Premium subscription activation via RevenueCat';
    displayName: 'Voucher';
    pluralName: 'vouchers';
  ...
  attributes: {
    ...
    expiry_date: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    max_uses: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<1>;
    publishedAt: Schema.Attribute.DateTime;
    redeemed_at: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['free_trial', 'discount']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'free_trial'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    push_notification_token: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    revenuecat_customer_id: Schema.Attribute.String &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
